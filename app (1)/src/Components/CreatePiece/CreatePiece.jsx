...
import {UploadModal} from "./Icon/Upload/UploadModal";
// import {ImgDropAndCrop} from "./Icon/Upload/learn/ImgDropAndCrop";
...
export class CreatePiece extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {binaryValue: 0, isHelpModal: false, isLoadModal: false, chooseIconModal: false, uploadIconModal: false};
        ...
        this.showChooseIcon = this.showChooseIcon.bind(this);
        this.closeChooseIcon = this.closeChooseIcon.bind(this);
        this.showUploadIcon = this.showUploadIcon.bind(this);
        this.closeUploadIcon = this.closeUploadIcon.bind(this);
    }
    ...
    showChooseIcon(color) {
        this.iconColor = color;
        this.setState({chooseIconModal: true});
    }

    closeChooseIcon() {
        this.setState({chooseIconModal: false});
    }

    showUploadIcon(color) {
        this.iconColor = color;
        this.setState({uploadIconModal: true})
    }
    
    closeUploadIcon() {
        this.setState({uploadIconModal: false});
    }
        ...
        return(
            <div>
                ...
                <Icon pieceImg={this.pieceImg} 
                      ...
                      setHelpText={this.setHelpText} 
                      togleHelpModal={this.togleHelpModal}
                      showChoose={this.showChooseIcon}
                      closeChoose={this.closeChooseIcon}
                      showUpload={this.showUploadIcon}
                      closeUpload={this.closeUploadIcon}
                      setUnsaved={this.setUnsaved} />
                ...
                <Board update={this.update} 
                       ...
                       setUnsaved={this.setUnsaved} />
                {this.state.uploadIconModal && (<UploadModal closeUpload={this.closeUploadIcon} 
                                                             color={this.iconColor} />) }
                {/* {this.state.uploadIconModal && (<ImgDropAndCrop />)} */}
                {this.state.chooseIconModal && (<ChooseModal closeChoose={this.closeChooseIcon} 
                                                    setImg={this.setPieceImg} 
                                                    color={this.iconColor} 
                                                    setUnsaved={this.setUnsaved} />) }
