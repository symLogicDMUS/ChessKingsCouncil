...
export class CouncilRulesLink extends React.Component {
    ...
    getBackgroundColor() {
        if (this.state.selected) return this.props.backgroundColorSelected;
    ...
    render() {
        return (
            <Link to="/CouncilRules" style={{ textDecoration: "none" }}>
                <div
                    className="council-rules-regular-link2"
                ...
                >
                    <div className="council-rules-nav-bar-button-icon-container2">
                        <img
                            src={`/Images/Navbar/council-rules-invert-${this.props.iconColor}.svg`}
                            style={{ position: "relative", top: 2, width: 26, height: 26 }}
                            alt=""
                        />
                    </div>
                    <div
                        className="council-rules-nav-bar-button-text-container2"
