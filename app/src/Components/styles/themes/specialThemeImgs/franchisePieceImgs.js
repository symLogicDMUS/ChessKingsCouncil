...
export const franchisePieceImgs = {
    star_wars: {
        ...
        Knight: {
            W: star_wars["y-wing.PNG"],
            B: star_wars["tie-defender.png"],
        },
        Bishop: {
            W: star_wars["a-wing.PNG"],
            B: star_wars["tie-interceptor.png"],
        },
        King: {
            W: star_wars["rebel-fleet-ship.PNG"],
            B: star_wars["star-destroyer.PNG"],
        },
        Queen: {
            W: star_wars["millenium-falcon.png"],
            B: star_wars["darth-vader-tie-fighter.PNG"],
        },
