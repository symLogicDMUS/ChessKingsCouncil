...
import "./MyPiecesRangeTable.css";
import { MyPiecesScrollArrow } from "./MyPiecesScrollArrow";


export class MyPiecesRangeTable extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={this.props.table}>
                <MyPiecesScrollArrow class_={this.props.upArrow} move={this.moveUp} />
                ...
                <MyPiecesScrollArrow class_={this.props.downArrow} move={this.moveDown} />
            </div>
        )
    }
}
