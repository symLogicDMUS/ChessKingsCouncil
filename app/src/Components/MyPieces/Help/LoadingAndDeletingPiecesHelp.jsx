    ...
    return (
        <>
            <Typography className={classes3.text} paragraph>
                ...
                On this page you can click the Load button to go to the Create
                Piece page with that piece and further edit it, or the Delete
                button to delete the piece. Pieces that are deleted will not
                affect games in progress, but no new game can be started with
                that piece.
            </Typography>
        </>
    );
