...
import {MyPiecesDisplaySquare as Square} from "./MyPiecesDisplaySquare";
import {MyPiecesDisplayPiece as Piece} from "./MyPiecesDisplayPiece";
...
import "./MyPiecesDisplayBoard.css";

export class MyPiecesDisplayBoard extends React.Component {
    ...
    getSqrClass(rf) {
        ...
        if (this.props.rangeType === "offsets") {
            if (this.jumpDisplays[rf]) {
                sqrClass = "my-pieces-display-board-offset-sqr"
            }
            else {
                sqrClass = "my-pieces-display-board-" + sqrClasses[rf]
            }
        }

        else {
            if (this.spanDisplays[rf]) {
                sqrClass = "my-pieces-display-board-span-sqr"
            }
            else {
                sqrClass = "my-pieces-display-board-" + sqrClasses[rf]
            }
    ...
    render() {
        ...
        return (
            <div className="my-pieces-display-board">
                {this.getBoard()}
            </div>
        )
    }
