        ...
        return (
            <div className="w-or-b-profile">
                ...
                <div className="my-img-window">
                    <img src={this.props.def.img} style={{ width: "120px", height: "120px" }} alt="icon of piece" />
                </div>
                <MyPiecesProfileWBHeader
                    class_="my-spans-header"
                ...
                <MyPiecesRangeTable
                    ranges={this.spans}
                    upArrow="my-spans-up-arrow"
                    table="my-spans-table"
                    downArrow="my-spans-down-arrow"
                />
                <MyPiecesProfileWBHeader
                    class_="my-offsets-header"
                    expand={this.props.expand}
                    pieceName={this.props.pieceName}
                    color={this.props.color}
                    rangeType="offsets"
...
export let test = () =>
    ReactDOM.render(
        <div className="profile-item">
            <MyPieceProfileWB def={def} color="W" />
        </div>,
