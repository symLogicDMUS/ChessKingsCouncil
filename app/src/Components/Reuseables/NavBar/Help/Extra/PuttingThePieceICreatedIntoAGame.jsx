        ...
        >
            <Typography className={classes2.text} paragraph>
                <ol>
                    ...
                    <li>
                        This will bring you to the Customize Game page.{ex9}
                    </li>
                    <li>
                        Select one of the 4 options for Queen, Rook, Knight, or
                        Bishop.{ex10}
                    </li>
                ...
                <Typography className={classes2.text} paragraph>
                    ...
                    >
                        On large screens the sub options are 4 icons: Queen,
            ...
            <Typography className={classes2.text}>
                The game starts with your piece in place of the piece you subbed
                for.
                <SeeExampleButton
                    theme={props.theme}
