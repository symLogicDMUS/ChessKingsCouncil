        ...
        <>
            <Typography paragraph className={classes.text}>
                ...
                <SeeExampleButton
                    isText={true}
                    theme={props.theme}
                    lgSrc={"Images/gif/wide/promo checkboxes.png"}
                    smSrc={"Images/gif/wide/promo checkboxes.png"}
                >
                ...
                <SeeExampleButton
                    isText={true}
                    theme={props.theme}
                    lgSrc={"Images/gif/thin/promo checkboxes.png"}
                    smSrc={"Images/gif/thin/promo checkboxes.png"}
                >
