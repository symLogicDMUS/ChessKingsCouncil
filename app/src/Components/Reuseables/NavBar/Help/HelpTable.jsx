...
export function HelpTable(props) {
    const { setHelpItem, onClose, theme, ...other } = props;

    const classes = useStyles({ theme: theme });

    return (
        <Dialog open={true} onBackdropClick={onClose} {...other}>
            <DialogTitle className={classes.color}>Help</DialogTitle>
                ...
                >
                    <List className={classes.list}>
                        ...
                        <ListItem
                            ...
                            className={classes.list_item}
                            onClick={() =>
                                setHelpItem("create piece page options")
                            }
                        >
