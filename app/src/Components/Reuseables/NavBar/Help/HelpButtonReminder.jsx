    ...
    return (
        <div>
            <Typography className={classes2.text} paragraph={true} {...other}>
                Remember: You can return to the help menu any time through the
                Help option on the NavBar
                <Button>
                    <Box className={classes.help_button}>
                        <ContactSupportIcon
                            className={clsx(classes2.text, {
                                [classes.icon]: true,
                            })}
                        />
                        <Typography className={classes2.text}>Help</Typography>
                    </Box>
                </Button>
            </Typography>
        </div>
