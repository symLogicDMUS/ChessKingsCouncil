...
import { useStyles } from "./MuiStatefulAccordion.jss";
 ...
 * @constructor
 */
export default function MuiStatefulAccordion({theme, style, rootStyle, addedStyle, neighborContentSize, children }) {
