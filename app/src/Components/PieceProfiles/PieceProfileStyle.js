...
import {
    pieceProfilesHeight as customGameProfilesHeight,
    profileHeaderHeight as customGameProfileHeaderHeight,
    margin as customGameProfilesMargin,
    ...
    desktop: {
        Profile: function (pieceProfilesStyle) {
            ...
            return {
                ...
                height:
                    pieceProfilesStyle.profileHeader().height +
                    columnGap +
                    row1 +
                    row2 +
                    columnGap +
