...
import {ProfileRangeBoard} from "./DisplayBoardModal/ProfileRangeBoard";
import {motion} from "framer-motion";
import {ProfileRange} from "./DisplayBoardModal/ProfileRange";
        ...
        <>
            ...
            <div className={classes.profile_wb}>
                <ProfileAvatar
                    ...
                    theme={theme}
                />
                <ProfileRange src={def.img} theme={theme} location='d4' range={def.spans} rangeType='spans' />
                <ProfileRange src={def.img} theme={theme} location='d4' range={def.offsets} rangeType='offsets' />
                {/*<ScrollTable*/}
                {/*    numRows={5}*/}
