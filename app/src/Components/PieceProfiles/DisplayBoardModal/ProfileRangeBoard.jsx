...
import { ProfileRangePiece as Piece } from "./ProfileRangePiece.jsx";
import { ProfileRangeSquare as Square } from "./ProfileRangeSquare";
import { getBinaryBoarAllFalse } from "../../helpers/getBinaryBoardAllFalse";
import { fontSize0040 } from "../../styles/fontSizes.jss";
import { binaryBoard } from "../../helpers/binaryBoard";
import { useStyles } from "./ProfileRangeBoard.jss";
...
export function ProfileRangeBoard({
    src,
    pieceName,
    range,
    rangeType,
    ...
    const [state, dispatch] = useReducer(reducer, {
        spans: getBinaryBoarAllFalse(),
        offsets: getBinaryBoarAllFalse(),
    });
    ...
    return (
        <div className={isModal ? classes.modal_board : classes.profile_board}>
            {getBoard()}
        </div>
    );
}

export default ProfileRangeBoard;
