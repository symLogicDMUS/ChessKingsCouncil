...
export class NewGameRangeTable extends React.Component {
    constructor(props) {
        ...
        } else this.inView = this.props.ranges;
    ...
    render() {
        return (
            <div className={this.props.table}>
                ...
                <div className="customize-range-list-item1">{this.inView[0]}</div>
                <div className="customize-range-list-item2">{this.inView[1]}</div>
                <div className="customize-range-list-item3">{this.inView[2]}</div>
                <div className="customize-range-list-item4">{this.inView[3]}</div>
                <div className="customize-range-list-item5">{this.inView[4]}</div>
