...
export const HelpText = (fontSize, theme) => ([
    <Typography key={uuidv4()} paragraph={true} style={help_text(fontSize, theme)}>
        ...
        <ol>
            ...
            <li>
                <i>Custom</i>: Use pieces that you created in your game. You created a piece by deciding how it moves and
            ...
            <li>
                <i>Council</i>:A modification of Chess where it is possible to have multiple Kings. See the Council Rules
    ...
    <Typography key={uuidv4()} paragraph={true} style={help_text(fontSize, theme)}>
        ...
        <p>
            ...
            that you created to see if you like it, demonstrate a sequence of moves to someone, or in the developer's case
