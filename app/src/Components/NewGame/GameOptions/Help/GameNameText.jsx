...
export function GameNameText(props) {
    ...
    return (
        ...
        <Typography className={classes.text} paragraph>
            ...
            >
                Save As
            </SeeExampleButton> button in used in the game. If you use the Save As button to give a different name given
            on the New Game page, the name given on the New Game page will be discarded.
        </Typography>
        </>
    );
}