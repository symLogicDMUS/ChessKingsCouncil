...
class Custom extends React.Component {
    ...
    render() {
        return (
            <Link>
                <g transform="translate(882.971 406.942)" onClick={() => this.props.setType("custom")}>
                    <g transform="translate(-25.929 -23.283)" className={this.state.iconClass}>
                        ...
                        <text className={this.props.classes.b} transform="translate(102.013 205.067)">
                            <tspan x={-53.27} y={0}>
                                {"Custom"}
                            </tspan>
                        </text>
