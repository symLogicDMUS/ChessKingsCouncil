...
class Council extends React.Component {
    ...
    render() {
        return (
            <Link>
                <g transform="translate(1075.593 405.978)">
                    <g transform="translate(-24.871 -34.396)" className={this.state.iconClass}>
                        ...
                        <text className={this.props.classes.b} transform="translate(99.719 216.863)">
                            <tspan x={-52.134} y={0}>
                                {"Council"}
                            </tspan>
                        </text>
                ...
                <rect
                    ...
                    onClick={() => this.props.setType("council")}
                />
            </Link>
        );
    }
