...
export function Standard({setType}) {
    ...
    return (
        <Link>
            <g transform="translate(691.658 406.633)" onClick={setType}>
                <g transform="translate(-23.283 -10.054)"
                   className={hover ? classes.icon_highlighted : classes.icon_normal}>
                    <path
                    ...
                    <text className={classes.b} transform="translate(98.625 191.516)">
                        <tspan x={-62.891} y={0}>
                            {"Standard"}
                        </tspan>
                    </text>
