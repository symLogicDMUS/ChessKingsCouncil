...
class Standard extends React.Component {
    ...
    render() {
        return (
            <Link>
                <g transform="translate(691.658 406.633)">
                    <g transform="translate(-23.283 -10.054)" className={this.state.iconClass}>
                        ...
                        <text className={this.props.classes.b} transform="translate(98.625 191.516)">
                            <tspan x={-62.891} y={0}>
                                {"Standard"}
                            </tspan>
                        </text>
                ...
                <rect
                    ...
                    onClick={() => this.props.setType("standard")}
                />
            </Link>
        );
    }
