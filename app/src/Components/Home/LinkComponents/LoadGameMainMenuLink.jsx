...
export class LoadGameIcon extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <Link to="/LoadGame">
                    <g transform="translate(1013.971 526.942)" className={this.state.iconClass}>
                        <g transform="translate(-514.929 -25.283)">
                            ...
                            <text className="page-link-text" transform="translate(100.426 224.645)">
                                <tspan x={-40.684} y={0}>
                                    {"Load"}
                                </tspan>
