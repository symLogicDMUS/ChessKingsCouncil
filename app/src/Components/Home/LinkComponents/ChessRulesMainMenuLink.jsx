        ...
        return (
            <>
                <a href="https://www.chess.com/learn-how-to-play-chess">
                    <g transform="translate(876.411 514.579)" className={this.state.iconClass}>
                        ...
                        <text className="page-link-text" transform="translate(103.964 210.499)">
                            <tspan x={-48.397} y={0}>
                                {"Chess"}
                            </tspan>
                ...
                <div style={{display: 'inline-block'}}>Chess Rules</div>
            </>
        );
    }
}
