...
export class NewGameIcon extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <Link to="/NewGame">
                <g transform="translate(338.827 525.928)">
                    <g transform="translate(-24.877 -14.81)" className={this.state.iconClass}>
                        ...
                        <text className="page-link-text" transform="translate(101.203 213.294)">
                            <tspan x={-37.589} y={0}>
                                {"New"}
                            </tspan>
