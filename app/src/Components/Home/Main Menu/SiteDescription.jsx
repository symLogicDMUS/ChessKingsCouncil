...
export function SiteDescription({ theme }) {
    ...
    const starWars = (
        <Button
            className={classes.inline_button}
            onClick={() => {
                themeDispatch({
    ...
    const resetTheme = (
        <Button
            className={clsx(classes.inline_button, {
    ...
    return (
        <Typography className={classes.paragraph}>
            ...
            option under game types. Your piece can start the game in place of a
            normal Chess piece, or be an option for Pawns to be promoted to when
            they reach the back row. You can also play classic Chess. There are
            a variety of sample images, pieces, and games, for new users. There
            are cool themes like {starWars}, {NBA} and {mechWarrior} that you
            can access through the Settings option in the side drawer. For
            further help, choose the help option in the side drawer. I hope that
            you enjoy the site!
        </Typography>
    );
}
