...
export class ShowOffsetsCheckbox extends React.Component {
    ...
    constructor(props) {
        super(props)
        this.state = {checkmark: <img src="/Images/checkmark/checkmark.svg" className="range-checkmark" />};
    ...
    togleCheck() {
        ...
        if (this.state.checkmark === null)
            this.setState({checkmark: <img src="/Images/checkmark/checkmark.svg" className="range-checkmark" />})
        else
