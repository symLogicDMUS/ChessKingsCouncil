    ...
    <div style={{ position: "absolute", zIndex: 6, width: 768, height: 325, left: 384, top: 504 }}>
        <svg viewBox="0 0 776 340">
            <defs>
                ...
                <clipPath id="rthem-b">
                    <rect className="rthem-a" width={217} height={43} transform="translate(584 274)" />
                </clipPath>
                <clipPath id="rthem-c">
                    <rect className="rthem-a" width={209} height={43} transform="translate(903 274)" />
                </clipPath>
            </defs>
            <g transform="translate(-457 -227)">
                <g className="rthem-b" transform="translate(465 241)">
                    ...
                    <rect className="rthem-h" x={2.5} y={2.5} width={763} height={320} rx={12.5} />
                </g>
                <rect className="rthem-c" width={220} height={220} transform="translate(583 318)" />
...
export let test = () => ReactDOM.render(<RangeHelpTextExtraModal />, document.getElementById("root"));
