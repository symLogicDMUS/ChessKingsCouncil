...
export class CreatedPieceProfiles extends React.Component {
    ...
    getProfiles() {
        ...
        for (var pieceName of pieceNames) {
            profiles.push(
                <Profile expand={this.expand} pieceName={pieceName} displayDefs={this.displayDefs}>
                    {ProfileHeader(pieceName, this.select, this.state.selected)}
                </Profile>
            );
        }
        return profiles;
                ...
                <div className="load-profile-modal">
                    <div className="created-piece-load-window">
                        <div className="created-piece-load-window-top-bar">
                            <div className="created-piece-load-window-title">Created Pieces</div>
                            <CreatedPieceClose togleLoadModal={this.props.togleLoadModal} />
                            <SearchBar updateSearch={this.updateSearch} />
                        </div>
                        <div className="created-piece-profiles">{this.getProfiles()}</div>
