    ...
    render() {
        return (
            <div className="create-piece-w-or-b-profile">
                ...
                <CreatePieceProfileWBHeader
                    class_="create-piece-spans-header"
                    expand={this.props.expand}
                    pieceName={this.props.pieceName}
                    color={this.props.color}
                    rangeType="spans"
                />
                <CreatePieceRangeTable
                    ranges={this.spans}
                    upArrow="create-piece-spans-up-arrow"
                    table="create-piece-spans-table"
                    downArrow="create-piece-spans-down-arrow"
                />
                <CreatePieceProfileWBHeader
                    class_="create-piece-offsets-header"
                    expand={this.props.expand}
                    pieceName={this.props.pieceName}
                    color={this.props.color}
                    rangeType="offsets"
                ...
                <CreatePieceRangeTable
                    ranges={this.offsets}
                    upArrow="create-piece-offsets-up-arrow"
...
export let test = () =>
    ReactDOM.render(
        <div className="profile-item">
            <CreatePieceProfileWB def={def} color="W" />
        </div>,
