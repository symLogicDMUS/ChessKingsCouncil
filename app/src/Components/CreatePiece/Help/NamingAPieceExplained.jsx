    ...
    return (
        <>
            <Typography className={classes2.text} paragraph>
                On larger screens, the text field for naming a piece is{" "}
                <SeeExampleButton
                    isText={true}
                    theme={props.theme}
                ...
                On smaller screens, the name field is opened by clicking the{" "}
                <SeeExampleButton
                    isText={true}
                    theme={props.theme}
                ...
                >
                    ...
                    in the right hand side icon column
                </SeeExampleButton>
                .
            </Typography>
            <Typography paragraph className={classes2.text}>
                You cannot use the name of one of the 6 regular pieces:{" "}
                <div className={classes2.emphasis}>
                    {" "}
                    Bishop, Knight, Rook, Queen, King, or Pawn
                </div>
                , as the name of a piece you're creating. The name cannot cannot
                contain the characters{"  "}
                <div className={classes2.emphasis}>. # $ [ ]</div>
                {"  "}
