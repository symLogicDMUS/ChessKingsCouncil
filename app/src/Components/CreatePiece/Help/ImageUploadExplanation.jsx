...
import "./ImageUploadExplanation.scss";
        ...
        <div>
            <Typography variant='subtitle2' className={classes2.sub_title}>Uploading an Image</Typography>
                <Typography className={classes3.text} paragraph>
                    Click the white or black image window to choose the white or black image for your piece. On smaller
                    screens the image icon <WallpaperIcon className={clsx(classes.icon, {[classes.icon_adjust]: true})} /> in the right hand side icons column
                    will bring up the image windows.
                </Typography>
