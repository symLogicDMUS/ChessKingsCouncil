...
export class LocationButton extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={`${this.props.rf} ${class_}`} onClick={this.select} onMouseEnter={this.hoverOn} onMouseLeave={this.hoverOff}>
                <img
                    src={require(`./${this.state.dir}/${this.props.rf}.svg`)}
