 ...
 */
export let helpTitle = "Location of Piece When Creating it";

export let HelpText = (
    <div>
        <p>You can position the piece in one of 4 locations in the center of the board: d4, d5, e4, or e5. </p>

        <img src="/Images/Help/4 locations.PNG" style={{ width: 200, height: 200 }} />
        <p>
        ...
        <img src="/Images/Help/Locations Tool.svg" />
        <p>
