...
import {styles} from "./newGameCustomization.jss";
...
<div>
  ...
  <p>Click the  <span className={this.props.classes.ilb_ei}><img src="/Images/expand/expand.svg" className={this.props.classes.ilb_ei_img} /></span>  Icon at the top of the span or offset list to view an image of a board with only that piece, and its span or offset squares highlighted.</p>
</div>