...
export function GameImageGridExplained(props) {
    ...
    return (
        <Typography className={classes.text} paragraph>
            Each game has an image of the current position of the board and the
            name of the game under the image. You can turn the names on and off
            with the
            <SeeExampleButton
                theme={props.theme}
            ...
            checkbox Currently, all game Categories (Standard, Custom, and
            Council) are together in 1 group.
        </Typography>
    );
}
