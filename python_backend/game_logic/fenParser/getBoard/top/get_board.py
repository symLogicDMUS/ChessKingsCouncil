from game_logic.helpers.save_bd import save_bd
from game_logic.fenParser.getBoard.get_pos_str import get_pos_str
from game_logic.fenParser.getBoard.get_trav_str import get_trav_str
from game_logic.fenParser.getBoard.num_to_sharps import num_to_sharps
from game_logic.fenParser.getBoard.pos_str_to_list import pos_str_to_list
from game_logic.fenParser.getBoard.convert_id import convert_ids
...
if __name__ == "__main__":
    ...
    print(board == \
          {(1, 1): 'WR1', (1, 2): 'WP1', (1, 3): '#', (1, 4): '#', (1, 5): '#', (1, 6): '#', (1, 7): 'BP1',
           (1, 8): 'BR1',
