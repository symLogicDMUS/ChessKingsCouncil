from game_logic.coordType.xy.rf_keys_to_xy import rf_keys_to_xy
from game_logic.coordType.xy.rf_values_to_xy import rf_values_to_xy
from game_logic.coordType.Depth import Depth
from pprint import pprint


def map_rf_to_xy(json_obj):
    """ """
    json_obj = rf_values_to_xy(json_obj, Depth())
    json_obj = rf_keys_to_xy(json_obj)
    return json_obj
        ...
        {'board': {'a1': 'WR1',
         ...
         'records': {'condition': '',
                     ...
                     'rooks_moved': {'a1': False,
                                     ...
                                     'h8': False},
                     'winner': '-'}}
    pprint(map_rf_to_xy(json_obj))
    pprint(map_rf_to_xy({'a1': 'WR1',
            'a2': '#',
            'a3': 'WN2',
            'a4': 'WP3',
            'a5': '#',
