from game_logic.step_funcs.step_funcs import step_1sqr90d
from game_logic.step_funcs.step_funcs import step_1sqr270d
...
if __name__ == "__main__":
    ...
    potential_1_sqr_jumps = get_potential_1_sqr_jumps(board, (2, 4), 'W')
