from game_logic.step_funcs.step_funcs import step_1sqr45d, step_1sqr135d, step_1sqr225d, step_1sqr315d


def get_potential_captures(sqr, board, color):
...
if __name__ == "__main__":
    ...
    potential_pawn_captures = get_potential_captures(board, (2, 4), 'W')
