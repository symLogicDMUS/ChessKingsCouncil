...
def get_num_pieces_checking_king(board, sqr, color, pd_dict, piece_defs, id_dict):
...
if __name__ == "__main__":
    ...
    print(get_num_pieces_checking_king(board, (4, 4), 'W', piece_defs, id_dict, pd_dict))
    print_board(board)
    print('\n')
    ...
    pd_dict = get_pathdata_dict(board, (6, 6), 'W', piece_defs, id_dict)
    print(get_num_pieces_checking_king(board, (6, 6), 'W', piece_defs, id_dict, pd_dict))
    print_board(board)
    print('\n')
