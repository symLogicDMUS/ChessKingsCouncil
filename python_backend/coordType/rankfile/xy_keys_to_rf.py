from coordType.rankfile.nest_level.funcs import funcs
from coordType.Depth import Depth
from pprint import pprint


def xy_keys_to_rf(json_obj, depth):
    """ """
    new_json_obj = {}
    for k in json_obj.keys():
        if type(json_obj[k]) == dict:
            json_obj[k] = xy_keys_to_rf(json_obj[k], depth)
        d = depth.get_new_depth(k)
        converter = funcs[d]
        new_json_obj[converter(k)] = json_obj[k]
    return new_json_obj
...
if __name__ == "__main__":
    ...
    pprint(xy_keys_to_rf(json_obj, Depth()))
