...
def get_actual_knight_threats(board, potential_knight_threats, color):
    ...
    return list(filter(lambda sqr: get_sqr_case(board, sqr[0], sqr[1], color) == ENEMY
                                   and get_piece_type(board[sqr]) == 'Knight', potential_knight_threats))
...
if __name__ == "__main__":
    ...
    knight_threats = get_actual_knight_threats(board, [(2, 3), (2, 5), (3, 2), (3, 6), (5, 2),
                                                       (5, 6), (6, 3), (6, 5)], 'W')
    ...
    knight_threats = get_actual_knight_threats(board, [(3, 2), (7, 2), (4, 3), (6, 3)], 'W')
    print(knight_threats)
    print('\n')
