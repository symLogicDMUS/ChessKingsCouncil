const  getPieceColor  = require("../color/getPieceColor");
const  getEnemyColor  = require("../color/getNextColor");
...
function getOffsetThreats(board, kingLoc, color, pieceDefs, idDict) {
    /* **/
