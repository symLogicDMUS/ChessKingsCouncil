...
*/
function step_1sqr0d(x, y) {
    /*step 1 square 0 degrees**/
    x += 1;
    return [x, y];
}

function step_1sqr45d(x, y) {
...
function step_1sqr90d(x, y) {
    /*step 1 square 90 degrees**/
    y += 1;
    return [x, y];
}

function step_1sqr135d(x, y) {
...
function step_1sqr180d(x, y) {
    /*step 1 square 180 degrees**/
    x -= 1;
    return [x, y];
}

function step_1sqr225d(x, y) {
...
function step_1sqr270d(x, y) {
    /*step 1 square 270 degrees**/
    y -= 1;
    return [x, y];
}

function step_1sqr315d(x, y) {
