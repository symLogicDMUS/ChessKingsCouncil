var  getUnicodePiece  = require("../printers/getUnicodePiece");
var  checkerboard  = require("../printers/checkerBoard");
var  isPiece  = require("../pieceType/isPiece");
const xyToRf = require("../coordType/crdCnvrt").xyToRf;
var colors = require('colors');


function printBoard(board, heading, ...highlights) {
