const getCoordPath = require("../pathsInfo/getCoordPath");
const getPath = require("../pathsInfo/getPath");
const getPiecesOnPath = require("./getPiecesOnPath");
const getStatuses = require("./getStatuses");
const getPieceMatchesPath = require("./getPieceMatchesPath");
...
function getPathData(board, sqr, color, pieceDefs, idDict, stepFunc) {
