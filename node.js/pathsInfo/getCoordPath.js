var  {step_1sqr90d, step_1sqr45d, step_1sqr0d, step_1sqr315d, 
      step_1sqr270d, step_1sqr225d, step_1sqr180d, step_1sqr135d} = require("../helpers/stepFuncs");
var  outOfBounds  = require("../sqrCase/oob");
var  sampleBoardDicts  = require("../testObjects/sampleBoardDicts");


function getCoordPath(x, y, takeStep) {
    /**
