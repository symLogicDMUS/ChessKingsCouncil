...
export const LoadGameLink = ({iconLabelPosLeft}) => (
  <Link to="/LoadGame">
    <div className="load-game-small-link">
      <svg viewBox="0 0 150.001 186.622">
        <g transform="translate(-76.481 -47.432)" className="link-icon-small">
      ...
      <span class="navbar-small-load-game-small-tooltiptext" style={{left:iconLabelPosLeft}}>Load Game</span>
    </div>
  </Link>
);
