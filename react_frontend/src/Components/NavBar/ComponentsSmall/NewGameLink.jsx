...
export const NewGameLink = ({iconLabelPosLeft}) => (
  <Link to="/NewGame">
  <div className="new-game-small-link">
    <svg viewBox="0 0 150 184.586">
      <g transform="translate(-94.204 -33.474)" className="link-icon-small">
    ...
    <span class="navbar-small-new-game-small-tooltiptext" style={{left:iconLabelPosLeft}}>New Game</span>
  </div>
</Link>
);
