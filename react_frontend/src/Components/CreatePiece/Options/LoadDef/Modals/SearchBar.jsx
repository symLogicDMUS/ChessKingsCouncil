...
export class SearchBar extends React.Component {
    ...
    render() {
        return (
            <div className="create-piece-load-top-bar-search" style={{backgroundColor: this.state.backgroundColor}}>
                <img src="/Images/magnifying-glass-b6n6n6.svg" 
                     className="create-piece-load-top-bar-search-magnifying-glass" 
                ...
                <input type="text" 
                       ...
                       className="create-piece-load-top-bar-search-box" 
