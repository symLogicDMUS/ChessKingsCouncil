...
export class Custom extends React.Component {
    ...
    handleChange() {
        this.props.setType("custom")
    }

    render() {
        return (
            <Link>
                <g transform="translate(882.971 406.942)" onClick={this.handleChange}>
                    <g transform="translate(-25.929 -23.283)" className="icon">
                        ...
                        <text className="b" transform="translate(102.013 205.067)">
                            <tspan x={-53.27} y={0}>
                                {"Custom"}
                            </tspan>
                        </text>
